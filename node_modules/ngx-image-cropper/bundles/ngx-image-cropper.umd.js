(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-image-cropper'] = {}, global.ng.core, global.ng.platformBrowser, global.ng.common));
    ...
    var CropperSettings = /** @class */ (function () {
         ...
         * @return {?}
         */
        CropperSettings.prototype.setOptions = function (options) {
            var _this = this;
            Object.keys(options)
                .filter(( /**
         * @param {?} k
         ...
         * @return {?}
         */
        CropperSettings.prototype.setOptionsFromChanges = function (changes) {
            var _this = this;
            Object.keys(changes)
                .filter(( /**
         * @param {?} k
         ...
         * @return {?}
         */
        CropperSettings.prototype.validateOptions = function () {
    ...
    ***************************************************************************** */
    ...
    var CropService = /** @class */ (function () {
         ...
         * @return {?}
         */
        CropService.prototype.crop = function (sourceImage, loadedImage, cropper, settings) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropService.prototype.getImagePosition = function (sourceImage, loadedImage, cropper, settings) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropService.prototype.getOffsetImagePosition = function (sourceImage, loadedImage, cropper, settings) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropService.prototype.getResizeRatio = function (width, height, settings) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropService.prototype.getQuality = function (settings) {
    ...
    var CropperPositionService = /** @class */ (function () {
         ...
         * @return {?}
         */
        CropperPositionService.prototype.resetCropperPosition = function (sourceImage, cropperPosition, settings) {
         ...
         * @return {?}
         */
        CropperPositionService.prototype.move = function (event, moveStart, cropperPosition) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropperPositionService.prototype.resize = function (event, moveStart, cropperPosition, maxSize, settings) {
            /** @type {?} */
         ...
         * @return {?}
         */
        CropperPositionService.prototype.checkAspectRatio = function (position, cropperPosition, maxSize, settings) {
            /** @type {?} */
            var overflowX = 0;
            /** @type {?} */
            var overflowY = 0;
         ...
         * @return {?}
         */
        CropperPositionService.prototype.getClientX = function (event) {
            var _a;
         ...
         * @return {?}
         */
        CropperPositionService.prototype.getClientY = function (event) {
            var _a;
    ...
    var LoadImageService = /** @class */ (function () {
         ...
         * @return {?}
         */
        LoadImageService.prototype.loadImageFile = function (file, cropperSettings) {
            var _this = this;
            return new Promise(( /**
             * @param {?} resolve
             * @param {?} reject
         ...
         * @return {?}
         */
        LoadImageService.prototype.loadImage = function (imageBase64, imageType, cropperSettings) {
         ...
         * @return {?}
         */
        LoadImageService.prototype.isValidImageType = function (type) {
         ...
         * @return {?}
         */
        LoadImageService.prototype.loadImageFromURL = function (url, cropperSettings) {
            var _this = this;
            return new Promise(( /**
             * @param {?} resolve
             * @param {?} reject
         ...
         * @return {?}
         */
        LoadImageService.prototype.loadBase64Image = function (imageBase64, cropperSettings) {
            var _this = this;
            return new Promise(( /**
             * @param {?} resolve
             * @param {?} reject
         ...
         * @return {?}
         */
        LoadImageService.prototype.transformImageBase64 = function (res, cropperSettings) {
         ...
         * @return {?}
         */
        LoadImageService.prototype.transformLoadedImage = function (loadedImage, cropperSettings) {
            return __awaiter(this, void 0, void 0, function () {
         ...
         * @return {?}
         */
        LoadImageService.prototype.loadImageFromBase64 = function (imageBase64) {
            return new Promise((( /**
             * @param {?} resolve
             * @param {?} reject
             * @return {?}
         ...
         * @return {?}
         */
        LoadImageService.prototype.getTransformedSize = function (originalSize, exifTransform, cropperSettings) {
            /** @type {?} */
    ...
    var ImageCropperComponent = /** @class */ (function () {
        ...
        function ImageCropperComponent(cropService, cropperPositionService, loadImageService, sanitizer, cd) {
            ...
            this.disabled = false;
            this.imageCropped = new i0.EventEmitter();
            this.startCropImage = new i0.EventEmitter();
            this.imageLoaded = new i0.EventEmitter();
            this.cropperReady = new i0.EventEmitter();
            this.loadImageFailed = new i0.EventEmitter();
            this.reset();
        }
        /**
         * @param {?} changes
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onChangesUpdateSettings = function (changes) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.onChangesInputImage = function (changes) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.isValidImageChangedEvent = function () {
            var _a, _b, _c;
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.setCssTransform = function () {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.loadImageFromURL = function (url) {
            var _this = this;
            this.loadImageService
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.setLoadedImage = function (loadedImage) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.loadImageError = function (error) {
            console.error(error);
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.sourceImageLoaded = function () {
            var _a, _b;
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.activatePinchGesture = function () {
            if (this.Hammer) {
                /** @type {?} */
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.keyboardAccess = function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.changeKeyboardStepSize = function (event) {
            /** @type {?} */
            var key = +event.key;
            if (key >= 1 && key <= 9) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.keyboardMoveCropper = function (event) {
            /** @type {?} */
        ...
        ImageCropperComponent.prototype.startMove = function (event, moveType, position) {
            ...
            this.moveStart = Object.assign({ active: true, type: moveType, position: position, clientX: this.cropperPositionService.getClientX(event), clientY: this.cropperPositionService.getClientY(event) }, this.cropper);
        };
        /**
         * @param {?} event
         * @return {?}
         */
        ImageCropperComponent.prototype.startPinch = function (event) {
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.setCropperScaledMaxSize = function () {
            var _a, _b;
            if ((_b = (_a = this.loadedImage) === null || _a === void 0 ? void 0 : _a.transformed) === null || _b === void 0 ? void 0 : _b.image) {
                /** @type {?} */
         ...
         * @return {?}
         */
        ImageCropperComponent.prototype.pinchStop = function () {
            if (this.moveStart.active) {
                this.moveStart.active = false;
                this.doAutoCrop();
            }
    ...
    ImageCropperComponent.propDecorators = {
        ...
        sourceImage: [{ type: i0.ViewChild, args: ['sourceImage', { static: false },] }],
        imageChangedEvent: [{ type: i0.Input }],
        imageURL: [{ type: i0.Input }],
        imageBase64: [{ type: i0.Input }],
        imageFile: [{ type: i0.Input }],
        format: [{ type: i0.Input }],
        transform: [{ type: i0.Input }],
        maintainAspectRatio: [{ type: i0.Input }],
        aspectRatio: [{ type: i0.Input }],
        resizeToWidth: [{ type: i0.Input }],
        resizeToHeight: [{ type: i0.Input }],
        cropperMinWidth: [{ type: i0.Input }],
        cropperMinHeight: [{ type: i0.Input }],
        cropperMaxHeight: [{ type: i0.Input }],
        cropperMaxWidth: [{ type: i0.Input }],
        cropperStaticWidth: [{ type: i0.Input }],
        cropperStaticHeight: [{ type: i0.Input }],
        canvasRotation: [{ type: i0.Input }],
        initialStepSize: [{ type: i0.Input }],
        roundCropper: [{ type: i0.Input }],
        onlyScaleDown: [{ type: i0.Input }],
        imageQuality: [{ type: i0.Input }],
        autoCrop: [{ type: i0.Input }],
        backgroundColor: [{ type: i0.Input }],
        containWithinAspectRatio: [{ type: i0.Input }],
        hideResizeSquares: [{ type: i0.Input }],
        cropper: [{ type: i0.Input }],
        alignImage: [{ type: i0.HostBinding, args: ['style.text-align',] }, { type: i0.Input }],
        disabled: [{ type: i0.HostBinding, args: ['class.disabled',] }, { type: i0.Input }],
        imageCropped: [{ type: i0.Output }],
        startCropImage: [{ type: i0.Output }],
        imageLoaded: [{ type: i0.Output }],
        cropperReady: [{ type: i0.Output }],
        loadImageFailed: [{ type: i0.Output }],
        onResize: [{ type: i0.HostListener, args: ['window:resize',] }],
        moveImg: [{ type: i0.HostListener, args: ['document:mousemove', ['$event'],] }, { type: i0.HostListener, args: ['document:touchmove', ['$event'],] }],
        moveStop: [{ type: i0.HostListener, args: ['document:mouseup',] }, { type: i0.HostListener, args: ['document:touchend',] }]
    };
    if (false) {
        /**
         * @type {?}
